    ...
    <form action={action} className="cn-setup">
      <div className="cn-setup-cols">
        <div className="cn-setup-fields">
          ...
          <div className="cn-field">
            <label htmlFor="logoUrl">Your logo</label>
            <input
              id="logoUrl"
              name="logoUrl"
              className="cn-input"
              placeholder="https://yourbrand.co.za/logo.svg"
              value={logoUrl}
              onChange={(e) => setLogoUrl(e.target.value)}
            />
            <p className="cn-label">
              Optional, and you can add it later. Without one your name is set in type, which is a perfectly good
              answer.
            </p>
          </div>
          ...
          <div className="cn-prev-pair">
            <div className="cn-prev-phone">
              {logoUrl.startsWith("https://") ? (
                ...
                <img src={logoUrl} alt="" className="cn-prev-logo" />
              ) : (
